...
Aunque ninguna banda por sí sola alcanzó un R² alto, el análisis con `statsmodels` incorporando el criterio AIC nos permite evaluar la utilidad relativa de cada una, teniendo en cuenta tanto la calidad del ajuste como la penalización por complejidad. Los valores de AIC más bajos corresponden a modelos con mejor balance entre ajuste y parsimonia.
